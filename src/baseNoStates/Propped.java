...
public class Propped extends State {
  ...
  @Override
  public void unlock() {
    System.out.println("Cannot unlock door " + door.getId() + " in PROPPED state - CLOSE IT FIRST!");
  }

  @Override
  public void lock() {
    System.out.println("Cannot lock door " + door.getId() + " in PROPPED state - CLOSE IT FIRST!");
  }

  @Override
  public void unlockShortly() {
    System.out.println("Cannot unlock_shortly door " + door.getId() + " in PROPPED state - CLOSE IT FIRST!");
  }

  public void closeDoor() {
    if (door.isClosed()) {
      System.out.println("Door " + door.getId() + " closed in PROPPED state - returning to LOCKED");
