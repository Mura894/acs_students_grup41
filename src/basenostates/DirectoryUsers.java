...
public final class DirectoryUsers {
  ...
  private void makeUsers() {
    ...
    logger.info("Groups created: Blank, Employee, Manager, Administrator");
    ...
    logger.info("Created {} users with their respective groups", users.size());

    // Show summary
    for (Group group : groups) {
      logger.debug("Group {} has {} users", group.getName(), group.getUsers().size());
    }
  }
